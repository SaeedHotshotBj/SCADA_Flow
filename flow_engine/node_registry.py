...
NODE_REGISTRY = {
    ...
    "TagMapper": {"config": [{"name": "mappings", "label": "Tag Definitions", "type": "table", "columns": [
        {"name": "register", "label": "Register", "type": "number"}, {"name": "name", "label": "Tag Name", "type": "text"},
        {"name": "datatype", "label": "Data Type", "type": "select", "options": ["FLOAT", "INT", "BOOL"]},
        {"name": "scale", "label": "Scale", "type": "number"}, {"name": "storage", "label": "Storage", "type": "select", "options": ["TIME", "TRIGGER"]},
        {"name": "interval", "label": "Time Interval (sec)", "type": "number"}, {"name": "trigger_register", "label": "Trigger Register", "type": "number"}, {"name": "trigger_value", "label": "Trigger Value", "type": "number"}
    ]}]},
    ...
    "ManagementPanelOutput": {"config": [
        ...
        {"name": "contract_fields", "label": "Contract Fields", "type": "table", "columns": [
            {"name": "name", "label": "Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}, {"name": "type", "label": "Control Type", "type": "text"}, {"name": "required", "label": "Required", "type": "select", "options": ["true", "false"]}
        ]},
        {"name": "contract_item_fields", "label": "Contract Product Fields", "type": "table", "columns": [
            {"name": "name", "label": "Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}, {"name": "type", "label": "Control Type", "type": "text"}, {"name": "required", "label": "Required", "type": "select", "options": ["true", "false"]}
        ]},
        {"name": "filter_fields", "label": "Filter Fields", "type": "table", "columns": [
            {"name": "name", "label": "Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}, {"name": "type", "label": "Control Type", "type": "text"}
        ]},
        {"name": "bom_product_fields", "label": "BOM Product Fields", "type": "table", "columns": [
            {"name": "name", "label": "Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}, {"name": "type", "label": "Control Type", "type": "text"}, {"name": "required", "label": "Required", "type": "select", "options": ["true", "false"]}
        ]},
        {"name": "bom_item_fields", "label": "BOM Item Fields", "type": "table", "columns": [
            {"name": "name", "label": "Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}, {"name": "type", "label": "Control Type", "type": "text"}, {"name": "required", "label": "Required", "type": "select", "options": ["true", "false"]}
        ]},
        {"name": "table_columns", "label": "Result Table Columns", "type": "table", "columns": [
            {"name": "name", "label": "Data Key", "type": "text"}, {"name": "label", "label": "Label", "type": "text"}
        ]}
    ]}
}
